...
clear all
close all
answers{1} = ['a) Passive aggressive converges more quickly.'...
    ' b) Constant has the lowest training error.' ...
    ' c) Passive aggressive has the lowest test error.' ...
    ' d) Linear SVM still does better than either updating strategy.'];
